...
<h3 class="card-title">Empleado registrado</h3>
...
<div class="card-body">
   <div class="row">
    <div class="col-md-12">
        <form action="../app/controllers/empleado/create.php"method="post">
            ...
            <div class="form-group">
                ...
                <input type="telefono"name="telefono" class="form-control" placeholder="Escriba el numero de telefono" required>
            </div>
