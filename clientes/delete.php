...
<h3 class="card-title">¿Estas seguro de eliminar los datos de este cliente?</h3>
   ...
   <div class="row">
    <div class="col-md-12">
            ...
            <div class="form-group">
                ...
                <input type="email"name="email" class="form-control"value="<?php echo $cedula;?>"disabled>
            </div>
            <div class="form-group">
                <label for="">Contacto</label>
                <input type="email"name="email" class="form-control"value="<?php echo $contacto;?>"disabled>
            </div>
            <div class="form-group">
                <label for="">Direccion</label>
                <input type="email"name="email" class="form-control"value="<?php echo $direccion;?>"disabled>
            </div>
            <hr>
            <div class="form-group">
